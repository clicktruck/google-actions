...
```bash
gh repo fork clicktruck/azure-actions --clone --remote
```
...
* [Build](https://github.com/clicktruck/google-packer/blob/main/ubuntu/22_04/BUILD.md)
* [Test](https://github.com/clicktruck/google-packer/blob/main/ubuntu/22_04/TEST.md)
